...
1.安装prettier(使用脚手架创建项目选择了prettier时已经安装了这个库了)

```shell
npm install prettier -D
```

2.配置[.prettierrc](../.prettierrc.json)文件：
...
3.创建[.prettierignore](../.prettierignore)忽略文件
...
![1690558200677](image/配置项目代码规范/1690558200677.png)
...
![1690559948322](image/配置项目代码规范/1690559948322.png)
...
[.eslintrc.cjs](.eslintrc.cjs)添加prettier插件：
...
4.VSCode中eslint的配置（在vue项目中可以不配置，在react项目中配置）
